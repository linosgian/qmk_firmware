...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   *  a    s      d      f      g        ||        h     j    k     l     ç
   *  z    x      c      v      b        ||        n     m    ,     .     ;
   *      esc    FΝ2   shift   ctrl      ||       alt   del  ins  enter
   *      tab    ralt  super   bksp      ||      space  FN1   ´     ~
   */
  [_xQ] = LAYOUT(
      KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,        KC_Y,    KC_U,    KC_I,    KC_O,     KC_P,
      KC_A,    KC_S,    KC_D,    KC_F,    KC_G,        KC_H,    KC_J,    KC_K,    KC_L,     KC_SCLN,
      KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,
      /*,   */ KC_ESC,  MO(_xF), KC_LSFT, KC_LCTL,     KC_LALT, KC_DEL,  KC_INS,  KC_ENT,
      /*,   */ KC_TAB,  KC_RALT, KC_LGUI, KC_BSPC,     KC_SPC,  MO(_xN), KC_LBRC, KC_QUOT),
  /*
   *  !     @      up     {     }        ||     pgup    7     8     9    *
   *  #    left   down  right   $        ||     pgdn    4     5     6    +
   *  [     ]      (      )     &        ||       '     1     2     3    \
   *       esc    FΝ2   shift  ctrl      ||      alt   del   ins    =
   *       tab    ralt  super  bksp      ||     space  FN1    -     0
   */
  [_xN] = LAYOUT(
   ...
   *  [     ]      (      )     &        ||      -      F1    F2    F3    F12
   *      reset   FΝ2   shift  ctrl      ||     alt     del   ins  enter
   *       tab    ralt  super  bksp      ||    space    FN1    ´     ~
