 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,  KC_MPLY,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  _______,
                             KC_LALT, KC_LSFT,RAISE, KC_BSPC,   KC_SPC,   LOWER,   KC_ENT, _______
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______,_______, _______, _______,
  _______, KC_EXLM,   KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                     KC_LPRN,   KC_7,   KC_8, KC_9,  KC_RPRN,  _______,
  KC_LABK, KC_AMPR, KC_ASTR,   KC_QUOT, KC_DQUO, KC_UNDS,                   KC_LCBR, KC_4, KC_5, KC_6, KC_RCBR, KC_RABK,
  _______, KC_GRV, KC_CIRC, KC_PLUS, KC_MINS, KC_PIPE, _______, _______, KC_LBRC, KC_1, KC_2, KC_3, KC_RBRC, _______,
                             KC_DOT, KC_EQL, KC_0, _______, _______,  _______, _______, _______
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                     _______, _______, _______, _______, _______, _______,
  _______,  RGB_TOG,  KC_PGUP,    KC_UP,    KC_PGDN,    _______,                     _______,   LCTL(KC_TAB),    LSFT(LCTL(KC_PGUP)),    _______,    _______,    _______,
  _______,  _______,    KC_LEFT,   KC_DOWN,   KC_RIGHT,   _______,                   LGUI(KC_SPC), LSFT(LCTL(KC_TAB)), LSFT(LCTL(KC_PGDN)), _______,   _______, _______,
  _______,   _______,   _______,   _______,   LCTL(LSFT(KC_V)),  _______,   _______, _______,  _______, _______, _______,  _______, _______, _______,
                             _______, _______, _______,  _______, KC_TAB,  KC_TILDE, KC_BSLS, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
